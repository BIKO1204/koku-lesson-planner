    ...
    <>
      ...
      <div style={menuWrapperStyle} aria-hidden={!menuOpen}>
        ...
        <div style={menuLinksWrapperStyle}>
          ...
          <button
            style={navBtnStyle}
            onClick={() => (setMenuOpen(false), router.push("/plan/history"))}
          >
            📖 計画履歴
          </button>
          <button
            style={navBtnStyle}
            onClick={() => (setMenuOpen(false), router.push("/practice/history"))}
          >
            📷 実践履歴
          </button>
          <button
            style={navBtnStyle}
            onClick={() => (setMenuOpen(false), router.push("/practice/share"))}
          >
            🌐 共有版実践記録
          </button>
          <button
            style={navBtnStyle}
            onClick={() => (setMenuOpen(false), router.push("/models/create"))}
          >
            ✏️ 教育観作成
          </button>
          ...
          <button
            style={navBtnStyle}
            onClick={() => (setMenuOpen(false), router.push("/models/history"))}
          >
            🕒 教育観履歴
          </button>
        </div>
                  ...
                  <div style={{ display: "flex", gap: 8, alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <button
                        type="button"
                        onClick={() => startEdit(m)}
                        style={{ ...actionBtnStyle, backgroundColor: "#1976d2", color: "#fff" }}
                      >
                        編集
                      </button>
                      <button
                        ...
                        style={{ ...actionBtnStyle, backgroundColor: "#e53935", color: "#fff" }}
                      >
                        削除
                      </button>
                    </div>
